...
#ifndef RCT_RCT_INDEX_GRAMMAR_HPP
#define RCT_RCT_INDEX_GRAMMAR_HPP
...
namespace rct {
    ...
    private:
        ...
        void copy(const rct_index_grammar &o){
    ...
    public:
        ...
        //! Copy constructor
        rct_index_grammar(const rct_index_grammar& o)
        {
            copy(o);
        }

        //! Move constructor
        rct_index_grammar(rct_index_grammar&& o)
        {
            *this = std::move(o);
        }


        rct_index_grammar &operator=(const rct_index_grammar &o) {
            if (this != &o) {
                copy(o);
            }
            return *this;
        ...
        rct_index_grammar &operator=(rct_index_grammar &&o) {
            if (this != &o) {
                m_total_objects = o.m_total_objects;
                m_speed_max = o.m_speed_max;
                m_t_max = o.m_t_max;
