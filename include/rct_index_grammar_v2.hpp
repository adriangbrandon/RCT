...
#ifndef RCT_RCT_INDEX_GRAMMAR_V2_HPP
#define RCT_RCT_INDEX_GRAMMAR_V2_HPP

#include <vector>
#include <snapshot.hpp>
#include <log_object_v2.hpp>
...
#include <rlz_repair_v2.hpp>

#define PRINT_STATS 1

namespace rct {

    template <uint64_t k = 2, class t_log_reference = log_reference_v2<>, class t_log_object = log_object_v2<>,
            class t_rlz = rlz_repair_v2_csa_bc_int64 >
    class rct_index_grammar_v2 {
    ...
    public:
        ...
        typedef typename rlz_type::rlz_factor_type factor_type;
    ...
    private:
        ...
        void copy(const rct_index_grammar_v2 &o){
    ...
    public:
        ...
        rct_index_grammar_v2() = default;

        rct_index_grammar_v2(const std::string &dataset_file, const size_type size_reference, const size_type period_snapshot) {
            ...
            std::cout << "Array of movements: " << std::endl;
            while (in) {
                in >> id >> t >> x >> y;
                if (in.eof()) break;
                if (id == old_id) {
            ...
            m_log_reference = log_reference_type(ref_movements, rlz.reference.lengths, rlz.reference.mbrs);
            ref_movements.clear();
            ...
            while (!in.eof() && id != -1) {
                ...
                //if (in.eof() || old_id == 11) id = (uint32_t) -1;
                if (id == old_id) {
                    int32_t diff_x = x - old_x;
                    int32_t diff_y = y - old_y;
                ...
                if (id != old_id && old_id != -1) {
                    ...
                    m_log_objects.emplace_back(log_object_type(trajectory, factors, &m_log_reference));
                    movements.clear();
                    trajectory.clear();
                }
                old_id = id;
        ...
        //! Copy constructor
        rct_index_grammar_v2(const rct_index_grammar_v2& o)
        {
            copy(o);
        }

        //! Move constructor
        rct_index_grammar_v2(rct_index_grammar_v2&& o)
        {
            *this = std::move(o);
        }


        rct_index_grammar_v2 &operator=(const rct_index_grammar_v2 &o) {
            if (this != &o) {
                copy(o);
            }
            return *this;
        ...
        rct_index_grammar_v2 &operator=(rct_index_grammar_v2 &&o) {
            if (this != &o) {
                m_total_objects = o.m_total_objects;
                m_speed_max = o.m_speed_max;
                m_t_max = o.m_t_max;
        ...
        void swap(rct_index_grammar_v2 &o) {
