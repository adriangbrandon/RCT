...
#ifndef RCT_RCT_INDEX_GRAMMAR_RTREE_HPP
#define RCT_RCT_INDEX_GRAMMAR_RTREE_HPP
...
namespace rct {
    ...
    template <class t_log_reference = log_reference<>, class t_log_object = log_object<>,
            class t_rlz = rlz_repair_csa_bc_int64 >
    class rct_index_grammar_rtree {
    ...
    private:
        ...
        void copy(const rct_index_grammar_rtree &o){
    ...
    public:
        ...
        rct_index_grammar_rtree() = default;
        rct_index_grammar_rtree(const std::string &dataset_file,
        ...
        //! Copy constructor
        rct_index_grammar_rtree(const rct_index_grammar_rtree& o)
        {
            copy(o);
        }

        //! Move constructor
        rct_index_grammar_rtree(rct_index_grammar_rtree&& o)
        {
            *this = std::move(o);
        }


        rct_index_grammar_rtree &operator=(const rct_index_grammar_rtree &o) {
            if (this != &o) {
                copy(o);
            }
            return *this;
        ...
        rct_index_grammar_rtree &operator=(rct_index_grammar_rtree &&o) {
            if (this != &o) {
                m_total_objects = o.m_total_objects;
                m_speed_max = o.m_speed_max;
                m_t_max = o.m_t_max;
        ...
        void swap(rct_index_grammar_rtree &o) {
