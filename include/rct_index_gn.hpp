...
#ifndef RCT_RCT_INDEX_GN_HPP
#define RCT_RCT_INDEX_GN_HPP

#include <vector>
#include <snapshot.hpp>
#include <log_object_gn.hpp>
#include <log_object_gn_c_diff_redundant.hpp>
#include <log_object_gn_max_wr_min.hpp>
#include <log_object_gn_c_diff_separately.hpp>
//#include <log_object_no_mbrs.hpp>
#include <log_reference_gn.hpp>
...
namespace rct {
    ...
    template <uint64_t k = 2, class t_log_reference = log_reference_gn<>, class t_log_object = log_object_gn<>,
    ...
    private:
        ...
        void copy(const rct_index_gn &o){
    ...
    public:
        ...
        rct_index_gn() = default;

        rct_index_gn(const std::string &dataset_file,
        ...
        //! Copy constructor
        rct_index_gn(const rct_index_gn& o)
        {
            copy(o);
        }

        //! Move constructor
        rct_index_gn(rct_index_gn&& o)
        {
            *this = std::move(o);
        }


        rct_index_gn &operator=(const rct_index_gn &o) {
            if (this != &o) {
                copy(o);
            }
            return *this;
        ...
        rct_index_gn &operator=(rct_index_gn &&o) {
            if (this != &o) {
                m_total_objects = o.m_total_objects;
                m_speed_max = o.m_speed_max;
                m_t_max = o.m_t_max;
        ...
        void print_log_sel(){
            ...
            for(const auto &log : m_log_objects){
                log.print_c_sel();
            }
        }
